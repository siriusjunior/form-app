...
// JSONの返却値のデータ型の一部を一致させるように受ける(cfL.53,39, cf.actions)
export type Colleges = { search: string; result: CollegeResult[] };
export type CollegeResult = { name: string; faculty: Faculty[] };
export type Faculty = { name: string; department: string[] };
